class SceneH1 extends Phaser.Scene {
  constructor() {
    super("SceneH1");
  }

  preload() {
    this.load.image("minidress200", "assets/costumglasesjoy.png");
...
class SceneH2 extends Phaser.Scene {
  constructor() {
    super("SceneH2");
  }

  preload() {
    this.load.image("minicostum200", "assets/costumchokerjoy.png");
